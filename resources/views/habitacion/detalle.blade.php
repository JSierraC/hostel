						...
						<div class="row">
							...
							<div class="hp-section">
								...
								<div class="hp-over">
									<ul class="nav nav-tabs hp-over-nav">
										<li class="active">
											<a data-toggle="tab" href="#home"><img src="{{asset('images/icon/a9.png')}}" alt=""> <span class="tab-hide">Food Menu</span>
											</a>
										</li>
										<li>
											<a data-toggle="tab" href="#menu1"><img src="{{asset('images/icon/a8.png')}}" alt=""> <span class="tab-hide">Overview</span>
											</a>
										</li>
										<li>
											<a data-toggle="tab" href="#menu2"><img src="{{asset('images/icon/a10.png')}}" alt=""> <span class="tab-hide">Facilities</span>
											</a>
										</li>
										<li>
											<a data-toggle="tab" href="#menu3"><img src="{{asset('images/icon/a11.png')}}" alt=""> <span class="tab-hide">Other Features</span>
											</a>
										</li>
									</ul>
									<div class="tab-content">
										<div id="home" class="tab-pane fade in active tab-space">
											<div class="res-menu"> <img src="{{asset('images/menu/1.jpg')}}" alt="">
											...
											<div class="res-menu"> <img src="{{asset('images/menu/2.jpg')}}" alt="">
											...
											<div class="res-menu"> <img src="{{asset('images/menu/3.jpg')}}" alt="">
												<h3>salted fried chicken <span>$45</span></h3> <span class="menu-item">Tomato soup with croutons, small ceasar salad, apple juice</span> </div>
											<div class="res-menu"> <img src="{{asset('images/menu/4.jpg')}}" alt="">
												<h3>salted fried chicken <span>$64</span></h3> <span class="menu-item">Tomato soup with croutons, small ceasar salad, apple juice</span> </div>
											<div class="res-menu"> <img src="{{asset('images/menu/5.jpg')}}" alt="">
												<h3>salted fried chicken <span>$45</span></h3> <span class="menu-item">Tomato soup with croutons, small ceasar salad, apple juice</span> </div>
											<div class="res-menu"> <img src="{{asset('images/menu/6.jpg')}}" alt="">
												<h3>salted fried chicken <span>$64</span></h3> <span class="menu-item">Tomato soup with croutons, small ceasar salad, apple juice</span> </div>
											<div class="res-menu"> <img src="{{asset('images/menu/7.jpg')}}" alt="">
												<h3>salted fried chicken <span>$45</span></h3> <span class="menu-item">Tomato soup with croutons, small ceasar salad, apple juice</span> </div>
											<div class="res-menu mar-bot-0"> <img src="{{asset('images/menu/8.jpg')}}" alt="">
												<h3>salted fried chicken <span>$64</span></h3> <span class="menu-item">Tomato soup with croutons, small ceasar salad, apple juice</span> </div>
										</div>
										...
										<div id="menu2" class="tab-pane fade tab-space">
											<div class="row">
												<div class="col-md-6 hp-ov-fac"> <img src="{{asset('images/hotel/1.jpg')}}" alt=""> </div>
												<div class="col-md-6">
													<p>Maecenas erat lorem, vulputate sed ex at, vehicula dignissim risus. Nullam non nisi congue elit cursus tempus. Nunc vel ante nec libero semper maximus. Donec cursus sed massa eget commodo. Phasellus semper neque id iaculis malesuada. Nulla efficitur dui vitae orci blandit tempor. Mauris sed venenatis nibh, sed sodales risus.</p>
													<p>Nam sit amet tortor in elit fermentum consectetur et sit amet eros. Sed varius velit at eros tempor sodales. Fusce at enim at lectus sollicitudin pharetra at in risus. Donec ut semper turpis. Maecenas lobortis ante ut eros scelerisque, at semper augue ullamcorper.</p>
												</div>
							...
							<div class="hp-section">
								...
								<div class="">
									<div class="h-gal">
										<ul>
											<li><img class="materialboxed" data-caption="Hotel Captions" src="{{asset('images/room/1.jpg')}}" alt="">
											</li>
											<li><img class="materialboxed" data-caption="Hotel Captions" src="{{asset('images/room/2.jpg')}}" alt="">
											</li>
											<li><img class="materialboxed" data-caption="Hotel Captions" src="{{asset('images/room/3.jpg')}}" alt="">
											</li>
											<li><img class="materialboxed" data-caption="Hotel Captions" src="{{asset('images/room/4.jpg')}}" alt="">
											</li>
											<li><img class="materialboxed" data-caption="Hotel Captions" src="{{asset('images/room/5.jpg')}}" alt="">
											</li>
											<li><img class="materialboxed" data-caption="Hotel Captions" src="{{asset('images/room/6.jpg')}}" alt="">
											</li>
											<li><img class="materialboxed" data-caption="Hotel Captions" src="{{asset('images/room/1.jpg')}}" alt="">
											</li>
											<li><img class="materialboxed" data-caption="Hotel Captions" src="{{asset('images/room/2.jpg')}}" alt="">
							...
							<div class="hp-section last-sec-spa">
								...
								<div class="lp-ur-all-rat">
									<ul>
										...
										<li>
											<div class="lr-user-wr-img"> <img src="{{asset('images/users/5.png')}}" alt=""> </div>
											<div class="lr-user-wr-con">
										...
										<li>
											<div class="lr-user-wr-img"> <img src="{{asset('images/users/6.png')}}" alt=""> </div>
											<div class="lr-user-wr-con">
